    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            loaded_skills: Specialized knowledge (from :mod:`quell.skills`)
                           injected into the system prompt.  Typically
                           prepared by calling
                           :func:`quell.skills.select_applicable` against
                           a context derived from the incident.
        """
